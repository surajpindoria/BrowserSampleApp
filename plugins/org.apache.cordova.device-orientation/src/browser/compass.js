...
;require('cordova/builder').recursiveMerge(navigator.compass, module.exports);window.navigator = window.navigator || {};
window.navigator.compass = window.navigator.compass || {};

;require('cordova/builder').recursiveMerge(navigator.compass, module.exports);